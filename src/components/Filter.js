...
export default function Filter(){
    return(
        <div className="filter flex text-sm flex-wrap xl:items-start text-[13px] sm:text-[15px] md:text-[17px] lg:text-[20px] xl:text-[24px]">
                ...
                <select name="sector" id="sector" className="my-3 mr-4 py-2 lg:px-3 sm:w-auto">
                    <option value="Sector">Sector</option>
                    <option value="fashion">Fashion</option>
                    <option value="agriculture">Agriculture</option>
                    <option value="recylcling">Recycling</option>
                </select>
                <select name="funding-stage" id="funding-stage" className="my-3 mr-4 py-2 lg:px-3 sm:w-auto">
